...
function dataUsage(planLimit, day, usage) {
  ...
  if (avgUse == avgDaily) {
    ...
    console.log(
      `You are EXCEEDING your average daily use (${avgUse} GB/day), continuing this high usage, you'll exceed your data plan by ${
        avgUse * 30 - planLimit
      }`
    );
  } else if (avgUse < avgDaily) {
    console.log(
      `You are under your daily limit by (${avgDaily - avgUse} GB/day)`
    );
  }
}
dataUsage(100, 15, 41);
